...
export class CreateCommentDto {
  ...
  @ApiProperty({ description: 'MongoDB ObjectID of the user writing the comment' })
  @IsNotEmpty()
  @IsMongoId()
  @Transform(({ value }) => Types.ObjectId.isValid(value) ? new Types.ObjectId(value) : value)
  ...
  @ApiPropertyOptional({ description: 'Optional MongoDB ObjectID of the parent comment' })
  @IsOptional()
  @IsMongoId()
  @Transform(({ value }) => Types.ObjectId.isValid(value) ? new Types.ObjectId(value) : value)
