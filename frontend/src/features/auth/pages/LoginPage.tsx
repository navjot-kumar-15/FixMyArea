    ...
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-xs text-slate-400 max-w-xs mx-auto">
          Select a role card to instantly log in and access protected dashboards.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-1.5 text-[10px] font-extrabold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest">
          <Sparkles className="w-3.5 h-3.5 animate-spin" /> 1-Click Role Access
        </div>
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-blue-200 dark:border-blue-900 bg-blue-50/40 dark:bg-blue-950/20 hover:border-blue-500/60 dark:hover:border-blue-500/60 text-left transition-all group shadow-sm flex flex-col justify-between h-32 hover:-translate-y-1 hover:shadow-md cursor-pointer"
          >
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-purple-200 dark:border-purple-900 bg-purple-50/40 dark:bg-purple-950/20 hover:border-purple-500/60 dark:hover:border-purple-500/60 text-left transition-all group shadow-sm flex flex-col justify-between h-32 hover:-translate-y-1 hover:shadow-md cursor-pointer"
          >
            <div className="flex items-center justify-between w-full">
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-rose-200 dark:border-rose-900 bg-rose-50/40 dark:bg-rose-950/20 hover:border-rose-500/60 dark:hover:border-rose-500/60 text-left transition-all group shadow-sm flex flex-col justify-between h-32 hover:-translate-y-1 hover:shadow-md cursor-pointer"
          >
            <div className="flex items-center justify-between w-full">
          ...
          <button
            ...
            className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40 hover:border-slate-500/60 dark:hover:border-slate-700/80 text-left transition-all group shadow-sm flex flex-col justify-between h-32 hover:-translate-y-1 hover:shadow-md cursor-pointer"
          >
            <div className="flex items-center justify-between w-full">
