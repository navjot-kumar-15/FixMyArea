...
export class AssignmentResponseDto {
  ...
  @ApiProperty({
    example: '60d0fe4f5311236168a109db',
    description: 'Associated report ID',
  })
  report_id: string;

  @ApiProperty({
    example: '60d0fe4f5311236168a109dc',
  ...
  @ApiProperty({
    ...
    description: 'ID of the admin who assigned the report',
  })
  assigned_by: string;
  ...
  @ApiProperty({
    example: 'Please inspect the pothole and fix it.',
    required: false,
    description: 'Optional instruction or note',
  })
  note?: string;
  ...
  @ApiProperty({
    ...
    required: false,
    description: 'Time accepted by worker',
  })
  accepted_at?: Date;
  ...
  @ApiProperty({
    ...
    required: false,
    description: 'Time rejected by worker',
  })
  rejected_at?: Date;
  ...
  @ApiProperty({
    example: 'Not my region of service.',
    required: false,
  ...
  @ApiProperty({
    example: false,
    description: 'Indicates if the assignment is soft deleted',
  })
  is_deleted: boolean;
